  ...
  try {
    ...
    if (body.status === "published" && updatedData) {
      if (process.env.EMAIL_USER && process.env.EMAIL_PASS) {
        ...
        // المعالجة الذكية للرابط لمنع أخطاء الـ 404
                    ...
                    <table width="100%" max-width="600px" cellpadding="0" cellspacing="0" style="max-width: 600px; background-color: #ffffff; border-radius: 24px; overflow: hidden; box-shadow: 0 10px 30px rgba(47, 158, 109, 0.1); border: 1px solid #f0f0f0;">
                      <tr>
                        <td style="background-color: #2F9E6D; padding: 40px 30px; text-align: center; border-bottom: 4px solid #1c744e;">
                          ...
                          <h1 style="color: #ffffff; margin: 0; font-size: 28px; font-weight: 700; font-family: 'Cairo', sans-serif;">تمت الموافقة والنشر</h1>
                        </td>
                      </tr>
                      <tr>
                        <td style="padding: 40px 30px;">
                          <h2 style="color: #073D35; font-size: 24px; margin: 0 0 20px 0; font-weight: 700; font-family: 'Cairo', sans-serif;">مرحباً ${updatedData.full_name}،</h2>
                          <p style="color: #555555; font-size: 16px; line-height: 1.8; margin: 0 0 25px 0; font-family: 'Cairo', sans-serif;">
                          ...
                          <div style="background-color: #f8faf9; border-right: 4px solid #C8A75A; padding: 20px; border-radius: 8px 0 0 8px; margin-bottom: 30px;">
                            <p style="color: #333333; margin: 0; font-size: 15px; line-height: 1.6; font-weight: 600; font-family: 'Cairo', sans-serif;">
                          ...
                          <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                              <td align="center">
                                <a href="${eventUrl}" style="display: inline-block; background-color: #073D35; color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 12px; font-weight: bold; font-size: 16px; border-bottom: 3px solid #052e28; font-family: 'Cairo', sans-serif;">عرض صفحة الفعالية</a>
                              </td>
                            </tr>
                          </table>
                        </td>
