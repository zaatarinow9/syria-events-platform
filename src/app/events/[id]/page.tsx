...
import { ArrowRight, MapPin, CalendarDays, Clock, Users, Target, Route, ShieldCheck, Share2, Link as LinkIcon, CheckCircle2, Navigation, Loader2 } from "lucide-react";
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-3xl border border-gray-200 shadow-sm p-6">
              ...
              <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <div className="w-12 h-12 rounded-full bg-[#C8A75A]/20 flex justify-center items-center shrink-0 border border-[#C8A75A]/30">
